...
import * as fastify$1 from 'fastify';
 ...
 */
declare function mixin$1(): _.Dictionary<string | number | undefined>;
declare const destination: pino__default.DestinationStream;
declare const options: pino__default.LoggerOptions<never>;
declare const args: readonly [pino__default.LoggerOptions<never>, pino__default.DestinationStream];
declare const iudexPino: {
    ...
    destination: pino__default.DestinationStream;
    options: pino__default.LoggerOptions<never>;
    args: readonly [pino__default.LoggerOptions<never>, pino__default.DestinationStream];
};
...
declare const stream: pino$1.default.DestinationStream;
 ...
 */
declare function mixin(): _.Dictionary<string | number | undefined>;
declare const logger: FastifyLoggerOptions<RawServerDefault> & PinoLoggerOptions;
declare const iudexFastify: {
    stream: pino$1.default.DestinationStream;
    mixin: typeof mixin;
    logger: FastifyLoggerOptions<RawServerDefault, fastify$1.FastifyRequest<fastify$1.RouteGenericInterface, RawServerDefault, http.IncomingMessage, fastify$1.FastifySchema, fastify$1.FastifyTypeProviderDefault, unknown, fastify$1.FastifyBaseLogger, fastify_types_type_provider_js.ResolveFastifyRequestType<fastify$1.FastifyTypeProviderDefault, fastify$1.FastifySchema, fastify$1.RouteGenericInterface>>, fastify$1.FastifyReply<RawServerDefault, http.IncomingMessage, http.ServerResponse<http.IncomingMessage>, fastify$1.RouteGenericInterface, unknown, fastify$1.FastifySchema, fastify$1.FastifyTypeProviderDefault, unknown>> & PinoLoggerOptions;
};
...
declare function instrument({ baseUrl, iudexApiKey, serviceName, instanceId, gitCommit, githubUrl, env, headers: configHeaders, }?: {
    baseUrl?: string;
    iudexApiKey?: string;
    serviceName?: string;
    instanceId?: string;
